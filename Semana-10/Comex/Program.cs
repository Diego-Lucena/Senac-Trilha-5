...
ProdutoRespository produtoRespository = new ProdutoRespository(context);
...
string mensagemBoasVindas = "Boas vindas aao COMEX";
...
async Task ExibirOpcoesDeMenu()
{
    ...
    {
        case 1:
            new MenuCriarProduto().CriarProduto(produtoRespository);
            await ExibirOpcoesDeMenu();
            break;
        case 2:
            Console.Clear();
            new MenuListarProdutos().ListaDeProdutos(produtoRespository);
            await ExibirOpcoesDeMenu();
            break;
        case 3:
            ...
            break;
        case 4:
            new MenuOrdenarProdutos().OrdernarProdutoPeloTipo(listaDeProdutos);
            await ExibirOpcoesDeMenu();
            break;
        case 5:
            new MenuOrdenarProdutos().OrdenarProdutoPeloPreco(listaDeProdutos);
            await ExibirOpcoesDeMenu();
            break;
        case 6:
            new MenuCriarPedido().CriarPedido(listaDeProdutos, listaDePedidos);
            await ExibirOpcoesDeMenu();
            break;
        case 7:
            new MenuListarPedidos().ListarPedidos(listaDePedidos);
            await ExibirOpcoesDeMenu();
            break;
        case -1:
